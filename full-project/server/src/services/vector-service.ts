// #book-ref ch12-production-rag/server/src/services/vector-service.ts
// #book-ref ch11-rag/server/src/services/vector-service.ts
// #book-ref ch10-ingestion/server/src/services/vector-service.ts
